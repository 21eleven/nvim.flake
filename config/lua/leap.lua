...
vim.keymap.set({'n', 'x', 'o'}, 'gk', '<Plug>(leap-forward-to)')
vim.keymap.set({'n', 'x', 'o'}, '<leader><leader>k', '<Plug>(leap-forward-to)')
...
vim.keymap.set({'n', 'x', 'o'}, 'gj', '<Plug>(leap-backward-to)')
vim.keymap.set({'n', 'x', 'o'}, '<leader><leader>j', '<Plug>(leap-backward-to)')
vim.keymap.set({'n', 'x', 'o'}, 'J', '<Plug>(leap-backward-to)')
